...
{    
    ...
    {
        String oldTag = ((IEntity) entity).getEntityData().getString(InfernalMobsCore.instance().getNBTTag());
    ...
    public float onHurt(EntityLivingBase mob, DamageSource source, float amount)
    {
        ...
        else if (source.getResponsibleEntity() != null)
        {
            if (source.getResponsibleEntity().worldObj.isRemote
    ...
    public boolean onUpdate(EntityLivingBase mob)
    {
        ...
        else
        {
            ...
            {
                attackTarget = LegacyHelper.helperInstance.getClosestVulnerablePlayerToEntity(mob.worldObj, mob, 7.5f);
            }
