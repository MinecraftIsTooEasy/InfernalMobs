...
public class MM_Alchemist extends MobModifier
{
    ...
    public boolean onUpdate(EntityLivingBase mob)
    {
        ...
        if (time > nextAbilityUse)
        {
            ...
            tryAbility(mob, LegacyHelper.helperInstance.getClosestVulnerablePlayerToEntity(mob.worldObj, mob, 12f));
        }
    ...
    {
        if (target == null || !LegacyHelper.helperInstance.canEntityBeSeen(mob, target))
        {
            return;
        }
